...
const toChecksum = function (address) {
...
const fromPrivate = function (privateKey) {
...
const encodeSignature = function ([v, r, s]) {
    Bytes.flatten([r, s, v]);
};

const decodeSignature = function (hex) {
    return [Bytes.slice(64, Bytes.length(hex), hex), Bytes.slice(0, 32, hex), Bytes.slice(32, 64, hex)];
};

const makeSigner = function (addToV) {
...
const recover = function (hash, signature) {
